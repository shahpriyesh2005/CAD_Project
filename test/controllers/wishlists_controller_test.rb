...
class WishlistsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create wishlist" do
    assert_difference('Wishlist.count') do
      post wishlists_url, params: { wishlist: { event_id: @wishlist.event_id, user_id: @wishlist.user_id, wishlist_date: @wishlist.wishlist_date } }
    end
  ...
  test "should update wishlist" do
    patch wishlist_url(@wishlist), params: { wishlist: { event_id: @wishlist.event_id, user_id: @wishlist.user_id, wishlist_date: @wishlist.wishlist_date } }
